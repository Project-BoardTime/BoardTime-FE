      ...
      <body className={inter.className}>
        <div className="flex min-h-screen">
          ...
          <div className="w-full md:w-1/2 bg-board-dark flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-md mx-auto p-8 bg-white text-board-dark rounded-2xl shadow-lg min-h-[600px] max-h-[80vh] overflow-y-auto flex flex-col justify-center">
              {" "}
